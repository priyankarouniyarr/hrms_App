...
import 'package:hrms_app/screen/leaves/approval_leaves.dart';
import 'package:hrms_app/screen/leaves/leavehistorypage.dart';
import 'package:hrms_app/screen/leaves/notleaves_approval.dart';
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => NotApprovalLeaves()));
                    },
                    child: Card(
                      elevation: 3,
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ApprovalLeaves()),
                      );
                    },
                    child: Card(
                      elevation: 3,

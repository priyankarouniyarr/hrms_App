...
class LeaveNotApproval {
  ...
  final double totalLeaveDays;
  final DateTime? extendedFromDate;
  final DateTime? extendedToDate;
  final String? extendedFromDateNp;
  final String? extendedToDateNp;
  final int? extendedLeaveTypeId;
  final String? extendedHalfDayStatus;
  final double extendedTotalLeaveDays;
  final String reason;
  final String? status;
  final String leaveTypeName;
  final String? extendedLeaveTypeName;
  final String employeeDisplayName;
  final bool isRecommendationApproved;
  final bool isApproved;
  final bool isSubstituteAccepted;
  ...
  final String leaveNo;
  final bool isInValidForApproval;
  final String? leaveApprovedBy;
  final String? approveRemarks;
  final DateTime? leaveApprovedOn;
  final String? rejectedBy;
  final String? recommendationApprovedBy;
  final DateTime? recommendationApprovedOn;
  final String? recommendationRemarks;
  final String? substituteAcceptRejectBy;
  final DateTime? substituteAcceptRejectOn;
  final String? substituteRemarks;
  final String? substituteEmployeeName;
  final String? recommendedByEmployeeName;
  LeaveNotApproval({
    required this.id,
    required this.applicationDate,
    required this.applicationDateNp,
  ...
  factory LeaveNotApproval.fromJson(Map<String, dynamic> json) {
    return LeaveNotApproval(
      id: json['id'],
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'halfDayStatus': halfDayStatus,
      'totalLeaveDays': totalLeaveDays,
      'extendedFromDate': extendedFromDate?.toIso8601String(),
      'extendedToDate': extendedToDate?.toIso8601String(),
      'extendedFromDateNp': extendedFromDateNp,
      'extendedToDateNp': extendedToDateNp,
      'extendedLeaveTypeId': extendedLeaveTypeId,
      'extendedHalfDayStatus': extendedHalfDayStatus,
      ...
      'leaveApprovedBy': leaveApprovedBy,
      'approveRemarks': approveRemarks,
      'leaveApprovedOn': leaveApprovedOn?.toIso8601String(),
      'rejectedBy': rejectedBy,
      'recommendationApprovedBy': recommendationApprovedBy,
      'recommendationApprovedOn': recommendationApprovedOn?.toIso8601String(),
      'recommendationRemarks': recommendationRemarks,
      'substituteAcceptRejectBy': substituteAcceptRejectBy,
      'substituteAcceptRejectOn': substituteAcceptRejectOn?.toIso8601String(),
      'substituteRemarks': substituteRemarks,
      'substituteEmployeeName': substituteEmployeeName,
      'recommendedByEmployeeName': recommendedByEmployeeName,
    };
...
class LeaveApplication {
  ...
  LeaveApplication({
    ...
    this.substituteAcceptRejectOn,
    this.substituteRemarks,
    required this.substituteEmployeeName,
    required this.recommendedByEmployeeName,
  });
